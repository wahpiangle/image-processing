...
def rgb_thresholding(image_key):
    ...
    noiseReduction = cv.GaussianBlur(imgRGB, (11, 11), 0)

    medium_thresholds_rgb = {
        "medium1": {
    ...
    threshold_values = medium_thresholds_rgb.get(image_key)
...
if __name__ == "__main__":
    for key in imageMap:
        # Check if the image is "medium" based on some criteria
